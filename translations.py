...
"nav_slow":      "Çox sürətli. {w} saniyə gözləyin.",
...
"menu_get_promo": "🎁 Partnyorlarımızdan mərc bonusu",
...
"ev_day_title":           "📅 Günü seçin:",
"ev_day_all":             "Bütün günlər",
"ev_day_today":           "Bu gün",
"ev_day_tomorrow":        "Sabah",
"ev_country_title":       "🌍 Ölkə/region seçin:",
"ev_country_all":         "Bütün ölkələr",
"ev_page_more":           "Daha çox ▶️",
"ev_page_prev":           "◀️ Əvvəlki",
"ev_back":                "◀️ Geri",
"ev_home":                "🏠 Əsas",
"ev_more_matches":        "📋 Daha çox matç",
"ev_tournaments_title":   "🏆 Turnirlər — {name}:",
...
"express_no_odds": "ℹ️ Əmsallar hazırda əlçatan deyil. Bir az sonra yenidən cəhd edin.",
"compare_ask":  "İki komanda adını yazın. Məsələn: Barcelona Real Madrid",
"menu_history": "📋 Tarix",
"menu_express": "⚡ Ekspress",
"menu_support": "🆘 Dəstək",
"menu_partners": "🤝 Partnyorlarımız",
"partners_text": "🤝 Partnyorlarımız — şirkətlərin siyahısı:",
"partners_btn": "🌐 Sayta keç",
...
"nav_slow":      "Слишком быстро. Подождите {w} сек.",
...
"menu_get_promo": "🎁 Бонус от партнёров на ставку",
...
"ev_day_title":           "📅 Выберите день:",
"ev_day_all":             "Все дни",
"ev_day_today":           "Сегодня",
"ev_day_tomorrow":        "Завтра",
"ev_country_title":       "🌍 Выберите страну/регион:",
"ev_country_all":         "Все страны",
"ev_page_more":           "Показать ещё ▶️",
"ev_page_prev":           "◀️ Предыдущие",
"ev_back":                "◀️ Назад",
"ev_home":                "🏠 В начало",
"ev_more_matches":        "📋 Ещё матчи",
"ev_tournaments_title":   "🏆 Турниры — {name}:",
...
"express_no_odds": "ℹ️ Коэффициенты сейчас недоступны. Попробуйте позже.",
"compare_ask": "Напишите две команды. Например: Barcelona Real Madrid",
"menu_history": "📋 История",
"menu_express": "⚡ Экспресс",
"menu_support": "🆘 Поддержка",
"menu_partners": "🤝 Наши партнёры",
"partners_text": "🤝 Наши партнёры — список компаний:",
"partners_btn": "🌐 Перейти на сайт",
...
"nav_slow":      "Too fast. Wait {w} seconds.",
...
"menu_get_promo": "🎁 Partner bonus for your bet",
...
"ev_day_title":           "📅 Choose a day:",
"ev_day_all":             "All days",
"ev_day_today":           "Today",
"ev_day_tomorrow":        "Tomorrow",
"ev_country_title":       "🌍 Choose a country/region:",
"ev_country_all":         "All countries",
"ev_page_more":           "Show more ▶️",
"ev_page_prev":           "◀️ Previous",
"ev_back":                "◀️ Back",
"ev_home":                "🏠 Start",
"ev_more_matches":        "📋 More matches",
"ev_tournaments_title":   "🏆 Tournaments — {name}:",
...
"express_no_odds": "ℹ️ Odds are currently unavailable. Please try again later.",
"compare_ask": "Type two teams. Example: Barcelona Real Madrid",
"menu_history": "📋 History",
"menu_express": "⚡ Express",
"menu_support": "🆘 Support",
"menu_partners": "🤝 Our partners",
"partners_text": "🤝 Our partners — the list of companies:",
"partners_btn": "🌐 Open the site",
...
"nav_slow":      "Çok hızlı. {w} saniye bekleyin.",
...
"menu_get_promo": "🎁 Ortaklarımızdan bahis bonusu",
...
"ev_day_title":           "📅 Gün seçin:",
"ev_day_all":             "Tüm günler",
"ev_day_today":           "Bugün",
"ev_day_tomorrow":        "Yarın",
"ev_country_title":       "🌍 Ülke/bölge seçin:",
"ev_country_all":         "Tüm ülkeler",
"ev_page_more":           "Daha fazla ▶️",
"ev_page_prev":           "◀️ Önceki",
"ev_back":                "◀️ Geri",
"ev_home":                "🏠 Başa",
"ev_more_matches":        "📋 Daha fazla maç",
"ev_tournaments_title":   "🏆 Turnuvalar — {name}:",
...
"express_title": "Günün ekspresi:",
"express_no_odds": "ℹ️ Oranlar şu anda mevcut değil. Lütfen daha sonra tekrar deneyin.",
"compare_ask": "İki takım adı yazın. Örnek: Barcelona Real Madrid",
"menu_history": "📋 Geçmiş",
"menu_express": "⚡ Kombine",
"menu_support": "🆘 Destek",
"menu_partners": "🤝 Ortaklarımız",
"partners_text": "🤝 Ortaklarımız — şirket listesi:",
"partners_btn": "🌐 Siteye git",
...
"nav_slow":      "Тым жылдам. {w} секунд күтіңіз.",
...
"menu_get_promo": "🎁 Серіктестерден ставкаға бонус",
...
"ev_day_title":           "📅 Күнді таңдаңыз:",
"ev_day_all":             "Барлық күндер",
"ev_day_today":           "Бүгін",
"ev_day_tomorrow":        "Ертең",
"ev_country_title":       "🌍 Ел/аймақты таңдаңыз:",
"ev_country_all":         "Барлық елдер",
"ev_page_more":           "Көбірек көрсету ▶️",
"ev_page_prev":           "◀️ Алдыңғы",
"ev_back":                "◀️ Артқа",
"ev_home":                "🏠 Басына",
"ev_more_matches":        "📋 Тағы матчтар",
"ev_tournaments_title":   "🏆 Турнирлер — {name}:",
...
"express_no_odds": "ℹ️ Коэффициенттер қазір қолжетімсіз. Кейінірек қайталап көріңіз.",
"compare_ask": "Екі команда атын жазыңыз. Мысалы: Barcelona Real Madrid",
"menu_history": "📋 Тарих",
"menu_express": "⚡ Экспресс",
"menu_support": "🆘 Қолдау",
"menu_partners": "🤝 Серіктестеріміз",
"partners_text": "🤝 Серіктестеріміз — компаниялар тізімі:",
"partners_btn": "🌐 Сайтқа өту",
...
"nav_slow":      "Juda tez. {w} soniya kuting.",
...
"menu_get_promo": "🎁 Hamkorlardan garov bonusi",
...
"ev_day_title":           "📅 Kunni tanlang:",
"ev_day_all":             "Barcha kunlar",
"ev_day_today":           "Bugun",
"ev_day_tomorrow":        "Ertaga",
"ev_country_title":       "🌍 Mamlakat/regionni tanlang:",
"ev_country_all":         "Barcha mamlakatlar",
"ev_page_more":           "Ko'proq ko'rsatish ▶️",
"ev_page_prev":           "◀️ Oldingi",
"ev_back":                "◀️ Orqaga",
"ev_home":                "🏠 Boshiga",
"ev_more_matches":        "📋 Yana o'yinlar",
"ev_tournaments_title":   "🏆 Turnirlar — {name}:",
...
"express_no_odds": "ℹ️ Koeffitsientlar hozircha mavjud emas. Keyinroq urinib ko'ring.",
"compare_ask": "Ikki jamoa nomini yozing. Masalan: Barcelona Real Madrid",
"menu_history": "📋 Tarix",
"menu_express": "⚡ Ekspress",
"menu_support": "🆘 Yordam",
"menu_partners": "🤝 Hamkorlarimiz",
"partners_text": "🤝 Hamkorlarimiz — kompaniyalar ro'yxati:",
"partners_btn": "🌐 Saytga o'tish",
...
"nav_slow":      "سريع جدًا. انتظر {w} ثانية.",
...
"menu_get_promo": "🎁 مكافأة الشركاء على الرهان",
...
"ev_day_title":           "📅 اختر اليوم:",
"ev_day_all":             "كل الأيام",
"ev_day_today":           "اليوم",
"ev_day_tomorrow":        "غدًا",
"ev_country_title":       "🌍 اختر الدولة/المنطقة:",
"ev_country_all":         "كل الدول",
"ev_page_more":           "عرض المزيد ▶️",
"ev_page_prev":           "◀️ السابق",
"ev_back":                "◀️ رجوع",
"ev_home":                "🏠 البداية",
"ev_more_matches":        "📋 مباريات أخرى",
"ev_tournaments_title":   "🏆 البطولات — {name}:",
...
"express_no_odds": "ℹ️ الأرباح غير متاحة حالياً. يرجى المحاولة لاحقاً.",
"compare_ask": "اكتب اسمي الفريقين. مثال: Barcelona Real Madrid",
"menu_history": "📋 السجل",
"menu_express": "⚡ إكسبريس",
"menu_support": "🆘 الدعم",
"menu_partners": "🤝 شركاؤنا",
"partners_text": "🤝 شركاؤنا — قائمة الشركات:",
"partners_btn": "🌐 الانتقال إلى الموقع",
