...
"menu_profile":  "👤 Profil",
"menu_lang":     "Dil dəyiş",
"profile_text":  "👤 PROFİL\n\n{name} | {lang} | {tz}\n📅 Qeydiyyat: {joined}\n\n📊 STATİSTİKA\nProqnozlar: {total_forecasts}\n{winrate}{streak}",
"stats_winrate":    "Uduş faizi: {pct}% ({wins}/{total} qeyd edilib)",
"stats_no_feedback":"Hələ heç bir proqnozu qeyd etməmisiz (✅/❌)",
"stats_streak":     "🔥 Cari seriya: {n} qalibiyyət",
...
"profile_text":  "👤 ПРОФИЛЬ\n\n{name} | {lang} | {tz}\n📅 В боте с: {joined}\n\n📊 СТАТИСТИКА\nПрогнозов: {total_forecasts}\n{winrate}{streak}",
"stats_winrate":    "Винрейт: {pct}% ({wins}/{total} отмечено)",
"stats_no_feedback":"Ещё не отмечали исходы (нажмите ✅/❌ в истории)",
"stats_streak":     "🔥 Серия: {n} побед подряд",
...
"stats_winrate":    "Win rate: {pct}% ({wins}/{total} rated)",
"stats_no_feedback":"No outcomes marked yet (tap ✅/❌ in history)",
"stats_streak":     "🔥 Streak: {n} wins in a row",
...
"profile_text":  "👤 PROFİL\n\n{name} | {lang} | {tz}\n📅 Kayıt: {joined}\n\n📊 İSTATİSTİK\nTahminler: {total_forecasts}\n{winrate}{streak}",
"stats_winrate":    "Kazanma oranı: {pct}% ({wins}/{total} işaretlendi)",
"stats_no_feedback":"Henüz sonuç işaretlemediniz (geçmişte ✅/❌ tuşlayın)",
"stats_streak":     "🔥 Seri: {n} üst üste galibiyet",
...
"profile_text":  "👤 ПРОФИЛЬ\n\n{name} | {lang} | {tz}\n📅 Тіркелген: {joined}\n\n📊 СТАТИСТИКА\nБолжамдар: {total_forecasts}\n{winrate}{streak}",
"stats_winrate":    "Жеңіс пайызы: {pct}% ({wins}/{total} белгіленді)",
"stats_no_feedback":"Әлі нәтиже белгілемедіңіз (тарихта ✅/❌ басыңыз)",
"stats_streak":     "🔥 Сериа: {n} жеңіс қатарынан",
...
"profile_text":  "👤 PROFIL\n\n{name} | {lang} | {tz}\n📅 Ro'yxatdan: {joined}\n\n📊 STATISTIKA\nBashoratlar: {total_forecasts}\n{winrate}{streak}",
"stats_winrate":    "G'alaba foizi: {pct}% ({wins}/{total} belgilangan)",
"stats_no_feedback":"Hali natija belgilanmagan (tarixda ✅/❌ bosing)",
"stats_streak":     "🔥 Seriya: {n} ta g'alaba ketma-ket",
...
"profile_text":  "👤 الملف الشخصي\n\n{name} | {lang} | {tz}\n📅 عضو منذ: {joined}\n\n📊 الإحصائيات\nالتوقعات: {total_forecasts}\n{winrate}{streak}",
"stats_winrate":    "نسبة الفوز: {pct}% ({wins}/{total} مُقيَّم)",
"stats_no_feedback":"لم تُقيِّم أي نتيجة بعد (اضغط ✅/❌ في السجل)",
"stats_streak":     "🔥 سلسلة: {n} انتصار متتالي",
